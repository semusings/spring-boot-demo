...
import dev.bhuwanupadhyay.demo.payment.model.PaymentPermission;
...
@Service
public class AuthorizationService implements PaymentPermission {
        ...
        try {
            ClientTupleKey tuple =
                    new ClientTupleKey() //
                            ...
                            ._object("payment:" + permission.orderId()) //
                            ._object("payment:" + permission.paymentId());
