...
public class ProductStockManager {
  ...
  public Product create(String name, String description, Double retailPrice,
      Integer initialQuantity) {
    Product product = this.products.save(
        new Product(name, description, retailPrice, initialQuantity));
